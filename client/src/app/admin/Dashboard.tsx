...
// import {Job, AuthUser, Resume} from "@/app/types/application";
...
// //   const [activeTab, setActiveTab] = useState<'jobs' | 'users' | 'resumes'>('jobs');
// //   const [jobs, setJobs] = useState<typeof mockJobs>(mockJobs);
// //   const [users, setUsers] = useState<typeof mockUsers>(mockUsers);
// //   const [resumes, setResumes] = useState<typeof mockResumes>(mockResumes);
